  ...
  <body class="bg-dark text-white font-sans">
    ...
    <nav class="bg-dark-light/80 backdrop-blur-md shadow-lg fixed w-full z-10">
      ...
      <div id="mobile-menu" class="hidden md:hidden fixed inset-x-0 top-[73px] bg-dark-light/95 backdrop-blur-md transition-all duration-300 ease-in-out transform translate-y-[-20px] opacity-0 rounded-b-xl shadow-lg border border-white/5">
        <div class="px-4 py-4 space-y-2">
          <a href="index.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
            <i class="fas fa-home mr-2"></i> Home
          </a>
          <a href="about.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
            <i class="fas fa-info-circle mr-2"></i> About
          </a>
          <a href="shop.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
            <i class="fas fa-server mr-2"></i> Shop
          </a>
          <a href="server.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
            <i class="fas fa-server mr-2"></i> Server
          </a>
          <a href="gallery.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
            <i class="fas fa-images mr-2"></i> Gallery
          </a>
          <a href="contact.php" class="block px-4 py-3 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center">
          ...
          <div class="mobile-dropdown legal-dropdown">
            ...
            <div class="mobile-dropdown-content pl-8 space-y-2 mt-1 overflow-hidden">
              <a href="terms.php" class="block px-4 py-2 text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center" data-mobile-link="true">
              ...
              <a href="rules.php" class="block px-4 py-2 text-white hover:text-primary hover:bg-dark/50 rounded-lg transition duration-300 flex items-center" data-mobile-link="true">
    ...
    <header class="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-dark-light">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4" data-aos="fade-up">Terms of <span class="text-primary">Service</span></h1>
        ...
        <div class="max-w-4xl mx-auto">
          <div class="bg-dark-light/50 backdrop-blur-sm p-8 rounded-xl shadow-xl space-y-8" data-aos="fade-up">
            ...
            <div>
              ...
              <p class="text-gray-300">Welcome to SIAN ROLEPLAY. By accessing our server and services, you agree to these terms. Please read them carefully.</p>
            </div>

            <!-- Account Terms -->
            <div>
              <h2 class="text-2xl font-bold mb-4">2. Account Terms</h2>
            ...
            <!-- Server Rules -->
            <div>
              <h2 class="text-2xl font-bold mb-4">3. Server Rules</h2>
              <ul class="list-disc list-inside text-gray-300 space-y-2">
                <li>Follow all roleplay guidelines and server rules</li>
                <li>Respect other players and staff members</li>
                <li>No cheating, exploiting, or using unauthorized modifications</li>
            ...
            <!-- Content Policy -->
            <div>
              <h2 class="text-2xl font-bold mb-4">4. Content Policy</h2>
              <ul class="list-disc list-inside text-gray-300 space-y-2">
                <li>No inappropriate or offensive content</li>
                <li>No copyright infringement</li>
                <li>No unauthorized advertising or promotion</li>
                <li>Content must comply with FiveM and Rockstar Games terms</li>
              </ul>
            </div>

            <!-- Payments and Refunds -->
            <div>
              <h2 class="text-2xl font-bold mb-4">5. Payments and Refunds</h2>
              <ul class="list-disc list-inside text-gray-300 space-y-2">
                <li>All purchases are final and non-refundable</li>
                <li>Donations are voluntary and non-refundable</li>
                <li>We reserve the right to modify prices at any time</li>
                <li>Payment information is handled securely by our payment processors</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p class="text-gray-300">We reserve the right to terminate or suspend accounts that violate these terms or server rules without prior notice.</p>
            </div>

            <!-- Changes to Terms -->
            <div>
              <h2 class="text-2xl font-bold mb-4">7. Changes to Terms</h2>
              <p class="text-gray-300">We may modify these terms at any time. Continued use of our services after changes constitutes acceptance of the new terms.</p>
            </div>

            <!-- Contact -->
            <div>
              <h2 class="text-2xl font-bold mb-4">8. Contact</h2>
              <p class="text-gray-300">For questions about these terms, please contact our support team through Discord or our contact form.</p>
            </div>
      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div class="legal-column">
            ...
            <ul class="space-y-2">
              <li><a href="terms.php" class="text-primary transition duration-300">Terms of Service</a></li>
          ...
          <div>
            ...
            <div class="mt-4">
              ...
              <div class="flex items-center mt-1">
                ...
                <button class="copy-button text-gray-400 hover:text-[#fd7e14] p-2 rounded-lg transition-all duration-300 hover:bg-[#10b981]/10 group/btn cursor-pointer ml-2">
